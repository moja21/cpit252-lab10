...
public abstract class Transaction {
    ...
    private final PassiveExpiringMap<String, String> cacheRegistry = new PassiveExpiringMap(
            TimeUnit.MINUTES.toMillis(timeToLiveMinutes));
    ...
    public final boolean executeTransaction(User user) {
